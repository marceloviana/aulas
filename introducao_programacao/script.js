...
for (let produto of produtos) {    
    ...
    <a href='#' class='btn btn-primary btn-primary-personally' data-nome-produto='${produto.nome}' data-bs-toggle='modal' data-bs-target='#exampleModal'>Adicionar no carrinho</a>\
    </div\
    ></div>\
    </div>`
...
var itensCarrinho = []
var botaoAdiconar = document.getElementById("adicionarCarrinho")
